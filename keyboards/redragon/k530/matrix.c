...
void matrix_init(void) {
    ...
    SN_CT16B1->PWMENB   =   (mskCT16_PWM7EN_EN  \
                            |mskCT16_PWM8EN_EN  \
                            |mskCT16_PWM9EN_EN  \
                            |mskCT16_PWM10EN_EN \
                            |mskCT16_PWM11EN_EN \
...
OSAL_IRQ_HANDLER(SN32_CT16B1_HANDLER) {
    ...
    if(current_row % 3 == 0)
    {
        SN_CT16B1->MR7  = led_state[row_ofst + 0 ].r;
        SN_CT16B1->MR8  = led_state[row_ofst + 1 ].r;
        SN_CT16B1->MR9  = led_state[row_ofst + 2 ].r;
        SN_CT16B1->MR10 = led_state[row_ofst + 3 ].r;
        SN_CT16B1->MR11 = led_state[row_ofst + 4 ].r;
        SN_CT16B1->MR12 = led_state[row_ofst + 5 ].r;
        SN_CT16B1->MR13 = led_state[row_ofst + 6 ].r;
        SN_CT16B1->MR14 = led_state[row_ofst + 7 ].r;
    ...
    if(current_row % 3 == 1)
    {
        SN_CT16B1->MR7  = led_state[row_ofst + 0 ].b;
        SN_CT16B1->MR8  = led_state[row_ofst + 1 ].b;
        SN_CT16B1->MR9  = led_state[row_ofst + 2 ].b;
        SN_CT16B1->MR10 = led_state[row_ofst + 3 ].b;
        SN_CT16B1->MR11 = led_state[row_ofst + 4 ].b;
        SN_CT16B1->MR12 = led_state[row_ofst + 5 ].b;
        SN_CT16B1->MR13 = led_state[row_ofst + 6 ].b;
        SN_CT16B1->MR14 = led_state[row_ofst + 7 ].b;
    ...
    if(current_row % 3 == 2)
    {
        SN_CT16B1->MR7  = led_state[row_ofst + 0 ].g;
        SN_CT16B1->MR8  = led_state[row_ofst + 1 ].g;
        SN_CT16B1->MR9  = led_state[row_ofst + 2 ].g;
        SN_CT16B1->MR10 = led_state[row_ofst + 3 ].g;
        SN_CT16B1->MR11 = led_state[row_ofst + 4 ].g;
        SN_CT16B1->MR12 = led_state[row_ofst + 5 ].g;
        SN_CT16B1->MR13 = led_state[row_ofst + 6 ].g;
        SN_CT16B1->MR14 = led_state[row_ofst + 7 ].g;
